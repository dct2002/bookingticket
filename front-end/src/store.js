...
import { getAllReducer, getAllByTimeReducer, userChangeReducer, userEditReducer, userInfoReducer, userReducer } from './redux/reducer/authReducer'
import {
    cinemaReducer,
    cinemaDetailReducer,
    cinemaEditReducer
...
import { editReservationReducer, getAllReservationReducer, getSummaryReducer, reservationReducer } from './redux/reducer/reservationReducer'
...
const reducer = combineReducers({
    ...
    user: userReducer,
    users: getAllReducer,
    usersByTime: getAllByTimeReducer,
