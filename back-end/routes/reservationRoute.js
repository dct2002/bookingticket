...
const {getAllReservations, getSummaryReservation, createReservation, updateReservation, deleteReservation, getOneReservation}
    = require('../controllers/reservationController')
const {verifyToken} = require('../middleware/verifyToken')

Router.route('/').get(getAllReservations).post(verifyToken, createReservation)
Router.route('/summary').get(getSummaryReservation)
