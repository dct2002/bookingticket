  ...
  return (
    <>
      <div className="text-white">
        ...
        <div className="border-2 lg:min-h-[7rem] max-h-max items-center border-gray-600 px-5 grid grid-cols-3">
          <p className="uppercase text-[12px] lg:text-[15px]">
            PHỤ ĐỀ - {showtime.typeMovie}
          </p>
